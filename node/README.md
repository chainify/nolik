...
A FRAME-based [Substrate](https://www.substrate.io/) node with a [Nolik Pallet](https://github.com/chainify/pallet-nolik).
...
external pallet which is [described here](https://github.com/chainify/pallet-nolik).
